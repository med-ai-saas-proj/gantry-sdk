...
// checks if the ThinkingTextMessageContentEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThinkingTextMessageContentEvent{}

// ThinkingTextMessageContentEvent Event indicating a piece of a thinking text message.
...
type _ThinkingTextMessageContentEvent ThinkingTextMessageContentEvent
...
func NewThinkingTextMessageContentEvent(delta string) *ThinkingTextMessageContentEvent {
	this := ThinkingTextMessageContentEvent{}
	var type_ string = "THINKING_TEXT_MESSAGE_CONTENT"
	this.Type = &type_
	this.Delta = delta
	return &this
}
...
func (o *ThinkingTextMessageContentEvent) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *ThinkingTextMessageContentEvent) SetRawEventNil() {
	o.RawEvent.Set(nil)
}
...
func (o ThinkingTextMessageContentEvent) MarshalJSON() ([]byte, error) {
...
func (o ThinkingTextMessageContentEvent) ToMap() (map[string]interface{}, error) {
...
func (o *ThinkingTextMessageContentEvent) UnmarshalJSON(data []byte) (err error) {
	...
	varThinkingTextMessageContentEvent := _ThinkingTextMessageContentEvent{}

	err = json.Unmarshal(data, &varThinkingTextMessageContentEvent)

	if err != nil {
		return err
	}

	*o = ThinkingTextMessageContentEvent(varThinkingTextMessageContentEvent)
...
type NullableThinkingTextMessageContentEvent struct {
	value *ThinkingTextMessageContentEvent
	isSet bool
}

func (v NullableThinkingTextMessageContentEvent) Get() *ThinkingTextMessageContentEvent {
	return v.value
}

func (v *NullableThinkingTextMessageContentEvent) Set(val *ThinkingTextMessageContentEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableThinkingTextMessageContentEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableThinkingTextMessageContentEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableThinkingTextMessageContentEvent(val *ThinkingTextMessageContentEvent) *NullableThinkingTextMessageContentEvent {
	return &NullableThinkingTextMessageContentEvent{value: val, isSet: true}
}

func (v NullableThinkingTextMessageContentEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableThinkingTextMessageContentEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
