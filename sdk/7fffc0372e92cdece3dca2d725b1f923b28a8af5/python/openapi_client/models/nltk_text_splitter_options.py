...
class NLTKTextSplitterOptions(BaseModel):
    """
    NLTKTextSplitterOptions
    """ # noqa: E501
    separator: Optional[StrictStr] = None
    language: Optional[StrictStr] = None
    use_span_tokenize: Optional[StrictBool] = None
    chunk_size: Optional[StrictInt] = None
    chunk_overlap: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["separator", "language", "use_span_tokenize", "chunk_size", "chunk_overlap"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "use_span_tokenize": obj.get("use_span_tokenize"),
