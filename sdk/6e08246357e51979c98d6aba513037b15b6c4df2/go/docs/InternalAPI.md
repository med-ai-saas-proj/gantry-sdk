...
------------- | ------------- | -------------
[**CaptureBillingTransactionUidCapturePost**](InternalAPI.md#CaptureBillingTransactionUidCapturePost) | **Post** /billing/{transaction_uid}/capture | Capture
[**PostBillingPost**](InternalAPI.md#PostBillingPost) | **Post** /billing/ | Post
...
func main() {
	...
	resp, r, err := apiClient.InternalAPI.CaptureBillingTransactionUidCapturePost(context.Background(), transactionUid).CaptureRequest(captureRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `InternalAPI.CaptureBillingTransactionUidCapturePost``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CaptureBillingTransactionUidCapturePost`: bool
	fmt.Fprintf(os.Stdout, "Response from `InternalAPI.CaptureBillingTransactionUidCapturePost`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.InternalAPI.PostBillingPost(context.Background()).PostRequest(postRequest).IdempotencyKey(idempotencyKey).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `InternalAPI.PostBillingPost``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PostBillingPost`: string
	fmt.Fprintf(os.Stdout, "Response from `InternalAPI.PostBillingPost`: %v\n", resp)
}
```
