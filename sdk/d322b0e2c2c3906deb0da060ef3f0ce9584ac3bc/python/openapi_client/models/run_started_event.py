...
class RunStartedEvent(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = 'RUN_STARTED'
    ...
    __properties: ClassVar[List[str]] = ["type", "timestamp", "rawEvent", "threadId", "runId", "parentRunId", "input"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['RUN_STARTED']):
            raise ValueError("must be one of enum values ('RUN_STARTED')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'RUN_STARTED',
            ...
            "input": RunAgentInput.from_dict(obj["input"]) if obj.get("input") is not None else None
        })
