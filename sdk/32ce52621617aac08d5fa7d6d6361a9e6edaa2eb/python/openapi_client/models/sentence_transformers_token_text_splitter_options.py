...
class SentenceTransformersTokenTextSplitterOptions(BaseModel):
    """
    SentenceTransformersTokenTextSplitterOptions
    """ # noqa: E501
    chunk_overlap: Optional[StrictInt] = None
    model_name: Optional[StrictStr] = None
    tokens_per_chunk: Optional[StrictInt] = None
    model_kwargs: Optional[Dict[str, Any]] = None
    chunk_size: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["chunk_overlap", "model_name", "tokens_per_chunk", "model_kwargs", "chunk_size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tokens_per_chunk": obj.get("tokens_per_chunk"),
