...
// checks if the TextMessageContentEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TextMessageContentEvent{}

// TextMessageContentEvent Event containing a piece of text message content.
...
type _TextMessageContentEvent TextMessageContentEvent
...
func NewTextMessageContentEvent(messageId string, delta string) *TextMessageContentEvent {
	this := TextMessageContentEvent{}
	var type_ string = "TEXT_MESSAGE_CONTENT"
	this.Type = &type_
...
func (o *TextMessageContentEvent) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *TextMessageContentEvent) SetRawEventNil() {
	o.RawEvent.Set(nil)
}
...
func (o TextMessageContentEvent) MarshalJSON() ([]byte, error) {
...
func (o TextMessageContentEvent) ToMap() (map[string]interface{}, error) {
...
func (o *TextMessageContentEvent) UnmarshalJSON(data []byte) (err error) {
	...
	varTextMessageContentEvent := _TextMessageContentEvent{}

	err = json.Unmarshal(data, &varTextMessageContentEvent)

	if err != nil {
		return err
	}

	*o = TextMessageContentEvent(varTextMessageContentEvent)
...
type NullableTextMessageContentEvent struct {
	value *TextMessageContentEvent
	isSet bool
}

func (v NullableTextMessageContentEvent) Get() *TextMessageContentEvent {
	return v.value
}

func (v *NullableTextMessageContentEvent) Set(val *TextMessageContentEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableTextMessageContentEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableTextMessageContentEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTextMessageContentEvent(val *TextMessageContentEvent) *NullableTextMessageContentEvent {
	return &NullableTextMessageContentEvent{value: val, isSet: true}
}

func (v NullableTextMessageContentEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTextMessageContentEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
