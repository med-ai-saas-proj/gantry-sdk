...
------------- | ------------- | -------------
[**capture_billing_transaction_uid_capture_post**](InternalApi.md#capture_billing_transaction_uid_capture_post) | **POST** /billing/{transaction_uid}/capture | Capture
[**post_billing_post**](InternalApi.md#post_billing_post) | **POST** /billing/ | Post
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of InternalApi->capture_billing_transaction_uid_capture_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling InternalApi->capture_billing_transaction_uid_capture_post: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of InternalApi->post_billing_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling InternalApi->post_billing_post: %s\n" % e)
```
