...
// checks if the TextMessageEndEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TextMessageEndEvent{}

// TextMessageEndEvent Event indicating the end of a text message.
...
type _TextMessageEndEvent TextMessageEndEvent
...
func NewTextMessageEndEvent(messageId string) *TextMessageEndEvent {
	...
	var type_ string = "TEXT_MESSAGE_END"
	this.Type = &type_
...
func (o *TextMessageEndEvent) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *TextMessageEndEvent) SetRawEventNil() {
	o.RawEvent.Set(nil)
}
...
func (o TextMessageEndEvent) MarshalJSON() ([]byte, error) {
...
func (o TextMessageEndEvent) ToMap() (map[string]interface{}, error) {
...
func (o *TextMessageEndEvent) UnmarshalJSON(data []byte) (err error) {
	...
	varTextMessageEndEvent := _TextMessageEndEvent{}

	err = json.Unmarshal(data, &varTextMessageEndEvent)

	if err != nil {
		return err
	}

	*o = TextMessageEndEvent(varTextMessageEndEvent)
...
type NullableTextMessageEndEvent struct {
	value *TextMessageEndEvent
	isSet bool
}

func (v NullableTextMessageEndEvent) Get() *TextMessageEndEvent {
	return v.value
}

func (v *NullableTextMessageEndEvent) Set(val *TextMessageEndEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableTextMessageEndEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableTextMessageEndEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTextMessageEndEvent(val *TextMessageEndEvent) *NullableTextMessageEndEvent {
	return &NullableTextMessageEndEvent{value: val, isSet: true}
}

func (v NullableTextMessageEndEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTextMessageEndEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
