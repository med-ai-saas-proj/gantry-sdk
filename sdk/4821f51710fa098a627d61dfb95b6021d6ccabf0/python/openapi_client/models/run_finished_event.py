...
class RunFinishedEvent(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = 'RUN_FINISHED'
    ...
    __properties: ClassVar[List[str]] = ["type", "timestamp", "rawEvent", "threadId", "runId", "result"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'RUN_FINISHED',
