...
class InputContentDataSource(BaseModel):
    """
    Inline base64-encoded source.
    """ # noqa: E501
    type: Optional[StrictStr] = 'data'
    value: StrictStr
    mime_type: StrictStr = Field(alias="mimeType")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "value", "mimeType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'data',
            "value": obj.get("value"),
