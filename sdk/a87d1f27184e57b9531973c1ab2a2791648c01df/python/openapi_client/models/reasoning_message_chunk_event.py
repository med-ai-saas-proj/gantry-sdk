...
class ReasoningMessageChunkEvent(BaseModel):
    """
    Event containing a chunk of reasoning message content.
    """ # noqa: E501
    type: Optional[StrictStr] = 'REASONING_MESSAGE_CHUNK'
    ...
    __properties: ClassVar[List[str]] = ["type", "timestamp", "rawEvent", "messageId", "delta"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['REASONING_MESSAGE_CHUNK']):
            raise ValueError("must be one of enum values ('REASONING_MESSAGE_CHUNK')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'REASONING_MESSAGE_CHUNK',
